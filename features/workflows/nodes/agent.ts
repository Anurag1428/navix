...
// /**
//  * Executes a Stagehand agent with the given instruction.
//  * @param stagehand - The Stagehand instance to execute the agent
//  * @param instruction - The natural language instruction for the autonomous browser task
//  * @returns Object containing success status, summary message, and completion status
//  */
...
//     // Stagehand v4 types don't include `agent` yet; cast to access it
//     const sh = stagehand as Stagehand & {
//         agent: (options: { model: string; executionModel: string }) => {
//             execute: (options: { instruction: string; maxSteps: number }) => Promise<{ message: string }>
//         }
//     }
...
//     return {
//         success: true,
//         message: result.message ?? "Agent task completed",
//         completed: true,
//         url: resolvedUrl,
//     }
// }
